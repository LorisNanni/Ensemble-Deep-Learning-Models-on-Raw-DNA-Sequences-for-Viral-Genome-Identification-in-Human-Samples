...
import json, copy
import argparse
from src.dataset.csv_dataset import CSVDataset, createCSVDatasetTrainVal
...
def main():
    ...
    train_file = os.path.join(args.data_folder, "training_data_anell_300_binary.csv")
    test_file  = os.path.join(args.data_folder, "test_data_anell_300_binary.csv")
    ...
    for model_infos in models_collection:
        ...
        train_df, valid_df = createCSVDatasetTrainVal(train_file, transform="onehot_encoding")
